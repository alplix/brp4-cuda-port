...
// like pointer
// TODO: that supports device memory and host memory across platforms and has utility member
// functions
...
// TODO : define some generic functions, e.g. for dumping to file or reading to file, allocating,
// deallocating ...
