###########################################################################
#   Copyright (C) 2011-2023 by Oliver Behnke                              #
...
DEPS = Makefile
OBJS = demod_binary.o demod_binary_ocl.o ocl_utilities.o hs_common.o rngmed.o erp_boinc_ipc.o erp_getopt.o erp_getopt1.o erp_utilities.o
...
#	./$(TARGET) -t $(EINSTEIN_RADIO_SRC)/../test/templates_400Hz_2_short.bank -l $(EINSTEIN_RADIO_SRC)/data/zaplist_232.txt -A 0.04 -P 4.0 -W -z -i $(EINSTEIN_RADIO_SRC)/../test/J1907+0740_dm_482.binary -c status_profile.cpt -o resu
