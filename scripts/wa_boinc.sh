...
cp "$REPO/src/compat/mingw_str_shim.h" /root/wa/inc_shim.h
...
$T-g++ -O2 -DNDEBUG -w -std=gnu++14 -I.. -I../lib "$REPO/src/compat/stackwalker_arm64_stub.cpp" -c -o /root/wa/sw_stub.o
