...
strip "$L/einsteinbinary_BRP4_linux_x86_64_modern" 2>/dev/null || true
chmod +x "$L/einsteinbinary_BRP4_linux_x86_64_modern"
...
cp "$KEPLER_L" "$L/einsteinbinary_BRP4_linux_x86_64_kepler"
strip "$L/einsteinbinary_BRP4_linux_x86_64_kepler" 2>/dev/null || true
chmod +x "$L/einsteinbinary_BRP4_linux_x86_64_kepler"
...
cp "$FERMI_L" "$L/einsteinbinary_BRP4_linux_x86_64_fermi"
strip "$L/einsteinbinary_BRP4_linux_x86_64_fermi" 2>/dev/null || true
chmod +x "$L/einsteinbinary_BRP4_linux_x86_64_fermi"
...
cp "$MODERN_W" "$W/einsteinbinary_BRP4_windows_x86_64_modern.exe"
...
cp "$KEPLER_W" "$W/einsteinbinary_BRP4_windows_x86_64_kepler.exe"
...
cp "$FERMI_W" "$W/einsteinbinary_BRP4_windows_x86_64_fermi.exe"
