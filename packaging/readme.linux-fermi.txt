BRP4 Binary Radio Pulsar Search - FERMI CUDA Build for LINUX x86_64
===================================================================
...
Requirements: 64-bit Linux and the last Fermi driver branch (390/391.x).
Keep libcufft.so.8.0 next to the binary - it is found automatically.
